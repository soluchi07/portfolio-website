    ...
    >
      ...
      >
        ...
        <ul className="about-list">
          {[
            { label: "Current Focus:", text: "Full-stack development, AI integration, data visualization" },
            { label: "Research:", text: "HuBMAP Fusion Researcher (NIH-affiliated) - spatial omics & autoimmune disease detection; Undergraduate Researcher @ Howard University - adverse drug event detection from clinical notes using NLP and pharmacovigilance datasets" },
            { label: "Skills:", text: "JavaScript, React, Python, C++, Supabase, Node.js, Git/GitHub" },
            { label: "Fun Fact:", text: "1st place at Microsoft AI Policython (CBC Week 2025); built first React app in a 24-hour hackathon" }
          ].map((item, index) => (
            <motion.li
              key={index}
